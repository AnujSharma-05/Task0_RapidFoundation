...
& $gh issue create `
  ...
  --label "milestone:0-monorepo,type:infra,layer:backend,priority:critical-path" `
  --body @"
## Goal
...
# ============================================================
# MILESTONE 1 — Auth Layer (already partially done)
# ============================================================

& $gh issue create `
  --title "[M1] Auth Layer — Users table, JWT register/login, middleware ✅" `
  --label "milestone:1-auth,type:feature,layer:backend" `
  --body @"
...
# ============================================================
# MILESTONE 2 — Groups Layer
# ============================================================

& $gh issue create `
  --title "[M2] Task 2.1 — Groups & GroupMembers tables (ORM models)" `
  --label "milestone:2-groups,type:feature,layer:backend,priority:critical-path" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:2-groups,type:feature,layer:backend" `
  --body @"
## Goal
...
# ============================================================
# MILESTONE 3 — WebSocket Ingestion Status
# ============================================================

& $gh issue create `
  --title "[M3] Task 3.1 — Raw WebSocket echo server" `
  --label "milestone:3-ws-ingestion,type:feature,layer:websocket" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:3-ws-ingestion,type:feature,layer:websocket,priority:critical-path" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:3-ws-ingestion,type:feature,layer:websocket,layer:backend" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:4-ws-streaming,type:feature,layer:backend" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:4-ws-streaming,type:feature,layer:websocket,priority:critical-path" `
  --body @"
## Goal
...
# ============================================================
# MILESTONE 5 — OpenClaw Plugin
# ============================================================

& $gh issue create `
  --title "[M5] Task 5.1 — Scaffold OpenClaw plugin + Telegram connection" `
  --label "milestone:5-openclaw,type:infra,layer:plugin" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:5-openclaw,type:feature,layer:plugin" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:5-openclaw,type:feature,layer:plugin,layer:websocket" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:6-polish,type:feature,layer:backend" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:6-polish,type:feature,layer:websocket" `
  --body @"
## Goal
...
& $gh issue create `
  ...
  --label "milestone:6-polish,type:infra" `
  --body @"
## Goal
